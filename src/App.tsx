        ...
        <div className="min-h-screen bg-[#0d0f12] text-[#cbd5e1] font-sans selection:bg-[#fca311] selection:text-black">
            ...
            <footer className="bg-[#0a0c0e] border-t border-[#22262e] py-12 text-[#64748b] font-mono text-xs">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div
                        className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center border-b border-[#22262e]/40 pb-8">
                    ...
                    <div
                        className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-slate-600">
                        <div>
