...
import { Award, Eye, ExternalLink, Calendar, ShieldCheck, X } from 'lucide-react';
...
export default function CertificateSection({ items }: CertificateSectionProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-16 space-y-3 font-mono">
          ...
          <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-2xl font-sans text-justify">
            Verifikasi kompetensi profesional saya melalui sertifikasi resmi yang diterbitkan oleh institusi teknologi global berstandar industri internasional.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {items.map((cert) => (
            ...
            >
              ...
              {/* Image preview with raw industrial overlay */}
        ...
        {/* LIGHTBOX MODAL - RETRO INDUSTRIAL OUTLINE */}
        <AnimatePresence>
          {selectedCert && (
            <div
            ...
            >
              ...
              <motion.div
                ...
                className="relative bg-[#14171c] border-2 border-[#2c313d] rounded-sm overflow-hidden shadow-2xl max-w-3xl w-full"
              >
                {/* Header title */}
